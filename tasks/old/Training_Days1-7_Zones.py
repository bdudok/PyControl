...
n_zones = 6 #how many zones per lap. high number = little running required between rewards. start with 10.
reward_lockout_time = 10 #s. how long the mouse can take reward before having to find the next zone. start with 10.
reward_lockout_drops = 30 #number of rewards the mouse can take before having to find the next zone. start with 50.
